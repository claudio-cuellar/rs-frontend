...
export function WhatsAppButton({
  ...
  const buildMessage = () => {
    ...
    let autoMessage = '¡Hola! 👋';
    
    if (propertyTitle) {
      autoMessage += `\n\nMe interesa la propiedad: *${propertyTitle}*`;
    }
  ...
  // WhatsApp URL
  const whatsappUrl = `https://wa.me/${cleanPhone}?text=${encodeURIComponent(buildMessage())}`;
  ...
  const variantStyles = {
    ...
    icon: 'bg-[#25D366] text-white hover:bg-[#20BD5A] rounded-full p-2.5 shadow-lg',
  };
